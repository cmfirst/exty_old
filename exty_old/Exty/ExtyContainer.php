<?php
/**
  * Create the code for Container
  * 
  * @param string $id   The id of the Container
  */
class ExtyContainer extends ExtyComponent{
    protected $_component=Exty::COMPONENT_CONTAINER;
    protected $_items=array();
    protected $_itemsConfig;
    protected $_initFormCode;
...
SENCHA;
     ...
     * @return \ExtyContainer
     */
    private function _setInitWinCode(){
        $this->_setItems();
        if($this->_dockedItems){
            $this->_initWinCode=<<<SENCHA
                    $this->_startDocked
                    $this->_dockedItems
                    ],
SENCHA;
...
SENCHA;
    ...
    public function getDefineCode($test=false){
        ...
        $this->_setInitWinCode();
        $this->setInitCode($this->_initWinCode);
